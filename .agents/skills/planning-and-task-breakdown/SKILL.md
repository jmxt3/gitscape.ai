...
Task 3: User can export a skill (skill schema + API + UI for export)
```
...
- `api/app/path/to/file.py`
- `web/components/path/to/component.tsx`
...
| **M** | 3-5 | One feature slice | Skill export flow |
